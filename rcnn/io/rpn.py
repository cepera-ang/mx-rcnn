...
def assign_anchor(feat_shape, gt_boxes, im_info, feat_stride=16,
    ...
    if DEBUG:
        ...
        means = old_div(_sums, (_counts + 1e-14))
        stds = np.sqrt(old_div(_squared_sums, _counts) - means ** 2)
        print('means', means)
        print('stdevs', stds)
    ...
    if DEBUG:
        ...
        _count = 1
        print('rpn: num_positive avg', old_div(_fg_sum, _count))
        print('rpn: num_negative avg', old_div(_bg_sum, _count))
